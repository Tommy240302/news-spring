...
/**
 * Controller để xử lý các yêu cầu liên quan đến thanh toán nhuận bút.
 * Tất cả các endpoint trong controller này đều dành cho vai trò ADMIN.
 */
@RestController
...
public class PaymentController {
    ...
    //-------------------------------------------------------------
    // CHỈNH SỬA ENDPOINT NÀY ĐỂ XỬ LÝ `multipart/form-data`
    //-------------------------------------------------------------
